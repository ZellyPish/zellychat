...
const buttonStyle = tw`h-10 px-5 text-purple-700 transition-colors duration-150 bg-purple-200 rounded-lg focus:shadow hover:bg-purple-300 w-full`
  ...
  return (
    <React.Fragment>
      <div css={tw`h-24 p-4 flex flex-row`}>
        ...
        />
        <p css={tw`pl-4 text-2xl font-semibold text-purple-200 self-center justify-self-start`}>{currentUser ? currentUser.displayName : 'Please Sign In'}</p>
      </div>
